...
_CONTRACT_DECLARED_KEYS: "dict[str, frozenset[str]]" = {
    "TrackerJSON": frozenset({
        ...
        "adherence", "dose_staleness", "block", "rotation_candidates",
        "core_week_spec", "arm_week_spec", "muscle_priority_tiers",
        "muscle_volume_targets", "volume_landmark_unit",
        ...
        "daily_activity_28d", "energy_28d", "recovery", "training_load",
        ...
        "body_fat_latest", "body_fat_trend_pct_per_4w",
        "lean_mass_latest", "lean_mass_trend_kg_per_4w",
        ...
        "session_target_min", "target_working_sets", "longevity_score",
