...
#   neck                no data.
#
# HITTABLE since 2026-08-03 — measured, restated, and now reachable:
...
#                       2026-08-02. From 2026-08-02 to 2026-08-03 it was
#                       filed UNHITTABLE on a narrower and correct ground:
#                       the catalog had ZERO primary entries for the
#                       muscle, so direct sets were not expressible and
#                       the restated MEV of 3 could not be hit by any
#                       prescription this coach could write.
#
#                       That gap is closed. `Cable External Rotation`
#                       (primary: external_rotators) landed in the catalog
#                       on 2026-08-03, which is the remedy the note below
#                       asked for. The target is now hittable; the reason
#                       to restate the offset never depended on that.
#
...
#                       table read as the better-served one. The remedy was
#                       always a catalog entry (external-rotation work
#                       exists — it was the vocabulary that was missing),
#                       never a softer landmark. That entry now exists.
